# CanDynamix Remocon
  ...
  Message date = start , stop
    ...
    <img src="https://github.com/candynamix/can_dynamix_remocon/blob/master/docs/start.png" width="300">
    <img src="https://github.com/candynamix/can_dynamix_remocon/blob/master/docs/run.png" width="300">
    The Green Button is Activated A Robot and Blue Button is Deactivated it. 

    <img src="https://github.com/candynamix/can_dynamix_remocon/blob/master/docs/AndroidStudio.png" width="300">
